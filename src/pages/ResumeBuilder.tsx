    ...
    <div className="container mx-auto px-4 py-8 max-w-6xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          <Card className="min-h-[800px] shadow-xl border-t-8 border-t-primary bg-white dark:bg-[#0F1726] rounded-lg overflow-hidden border-border/50 dark:border-white/[0.08]">
            <CardContent className="p-8 md:p-12 space-y-8">
              {/* Mock Resume Rendering */}
              <div className="border-b pb-6 text-center">
                <h1 className="text-3xl font-bold text-foreground mb-2">Rajesh Kumar</h1>
                <p className="text-lg text-primary font-medium">Frontend Developer</p>
                <p className="text-sm text-muted-foreground mt-2">rajesh@example.com • linkedin.com/in/rajeshk</p>
              </div>
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2">
                  {['React', 'TypeScript', 'Accessibility (WCAG)', 'Tailwind CSS'].map(skill => (
                    <span key={skill} className="px-3 py-1 bg-muted dark:bg-[#162033] text-foreground rounded text-sm border border-border/50 dark:border-white/[0.08]">
                      {skill}
                    </span>
                  ))}
                </div>
              ...
              <div>
                ...
                <div className="mb-4">
                  <div className="flex justify-between items-baseline">
                    <h3 className="font-bold text-foreground">Junior Developer</h3>
