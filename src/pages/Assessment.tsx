          ...
          <Card className="mb-8 premium-card">
            ...
            <CardContent className="pt-6">
              ...
              <div className="mt-6 p-5 bg-gradient-to-r from-primary/10 to-indigo-500/10 rounded-2xl flex items-center gap-4 border border-primary/20">
                <div className="bg-white dark:bg-[#162033] p-3 rounded-full shadow-sm">
  ...
  return (
    <div className="container mx-auto px-4 py-8 md:py-16 max-w-3xl">
      <div className="flex items-center justify-between mb-8">
        ...
        <div className="flex items-center gap-2 bg-white dark:bg-[#0F1726] border border-border/50 dark:border-white/[0.08] shadow-sm px-4 py-2 rounded-full font-mono text-lg font-medium">
                    ...
                    <Button
                      ...
                      className={`w-full justify-start text-left h-auto py-4 px-6 text-lg whitespace-normal rounded-xl transition-all ${
                        selected 
                          ...
                          : 'hover:border-primary/40 hover:bg-primary/5 bg-white dark:bg-[#0F1726] border-border/50 dark:border-white/[0.08]'
                      }`}
