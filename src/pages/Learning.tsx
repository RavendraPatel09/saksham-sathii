          ...
          <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4">
                👋 Welcome back, <span className="text-emerald-600 dark:text-emerald-400">Rahul!</span>
              </h1>
              ...
              <div className="flex flex-wrap gap-2 mb-6">
                <Badge variant="secondary" className="bg-indigo-500/15 text-indigo-600 dark:text-indigo-400 hover:bg-indigo-500/25 border-none px-3 py-1">Hindi Learning</Badge>
                ...
                <Badge variant="secondary" className="bg-emerald-500/15 text-emerald-600 dark:text-emerald-400 hover:bg-emerald-500/25 border-none px-3 py-1"><Ear className="w-3 h-3 mr-1" /> Screen Reader Mode</Badge>
                <Badge variant="secondary" className="bg-amber-500/15 text-amber-600 dark:text-amber-400 hover:bg-amber-500/25 border-none px-3 py-1"><Flame className="w-3 h-3 mr-1" /> 12-Day Streak</Badge>
              </div>
            </div>
            
            <div className="grid grid-cols-2 gap-4">
              <Card className="bg-white/60 dark:bg-[#0F1726]/80 backdrop-blur-md border-emerald-500/20 shadow-lg">
              ...
              <Card className="bg-white/60 dark:bg-[#0F1726]/80 backdrop-blur-md border-teal-500/20 shadow-lg">
                <CardContent className="p-6">
                  <div className="flex justify-between items-start mb-2">
              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="space-y-4">
                  ...
                  <div className="flex flex-wrap gap-2 pt-2">
                    <Badge variant="outline" className="cursor-pointer hover:bg-emerald-500/10 dark:hover:bg-emerald-500/20 text-xs py-1.5"><Sparkles className="w-3 h-3 mr-1" /> What should I learn next?</Badge>
                    <Badge variant="outline" className="cursor-pointer hover:bg-emerald-500/10 dark:hover:bg-emerald-500/20 text-xs py-1.5"><Briefcase className="w-3 h-3 mr-1" /> Show job-ready skills</Badge>
                    <Badge variant="outline" className="cursor-pointer hover:bg-emerald-500/10 dark:hover:bg-emerald-500/20 text-xs py-1.5"><Target className="w-3 h-3 mr-1" /> Find my weaknesses</Badge>
                  </div>
                </div>
              ...
              <CardContent>
                <div className="space-y-6 relative before:absolute before:inset-0 before:ml-[15px] before:w-0.5 before:-translate-x-px before:bg-gradient-to-b before:from-emerald-500 before:via-emerald-500/50 before:to-muted md:before:mx-auto md:before:translate-x-0">
                  ...
                  <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                    <div className="flex items-center justify-center w-8 h-8 rounded-full border-4 border-white dark:border-[#070B14] bg-emerald-500 text-white shadow-sm md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 shrink-0">
                      <CheckCircle2 className="w-4 h-4" />
                    </div>
                    <div className="w-[calc(100%-3rem)] md:w-[calc(50%-2rem)] p-4 rounded-xl border bg-emerald-500/5 shadow-sm">
                      <h4 className="font-bold text-emerald-600 dark:text-emerald-400">Excel Basics Completed</h4>
                  ...
                  <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                    ...
                    <div className="w-[calc(100%-3rem)] md:w-[calc(50%-2rem)] p-4 rounded-xl border bg-emerald-500/5 shadow-sm">
                      <h4 className="font-bold text-emerald-600 dark:text-emerald-400">Intro to Accessibility</h4>
                      <p className="text-sm text-muted-foreground">+100 XP • 1 hour</p>
                    </div>
                  </div>

                  <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                    <div className="flex items-center justify-center w-8 h-8 rounded-full border-4 border-white dark:border-[#070B14] bg-muted-foreground/30 text-background shadow-sm md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 z-10 shrink-0">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {courses.map((course, index) => (
              <Card key={course.id} className="premium-card flex flex-col h-full overflow-hidden group">
                ...
                <CardContent className="pt-6 flex-1 flex flex-col z-20 bg-white/80 dark:bg-[#0F1726]/90 backdrop-blur-md">
