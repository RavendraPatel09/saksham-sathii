            ...
            <div className="bg-muted/30 border border-border/50 rounded-2xl p-4 mb-8">
              <div className="flex flex-wrap gap-3 items-center justify-between">
                <div className="flex flex-wrap gap-3">
                  <Button variant="outline" className="rounded-full bg-white dark:bg-[#0F1726] border-border/50 text-muted-foreground hover:text-foreground shadow-sm">
                    ...
                    <Card className={`premium-card h-full flex flex-col ${index === 0 ? 'ring-2 ring-primary/30 shadow-[0_0_30px_rgba(37,99,235,0.15)]' : ''}`}>
                      <CardContent className="p-0 flex-1">
                        <div className="p-6 pb-4 relative overflow-hidden">
                          ...
                          <div className="flex flex-wrap gap-4 text-sm mb-6 bg-muted/50 dark:bg-[#111A2B] p-3 rounded-xl border border-border/50">
