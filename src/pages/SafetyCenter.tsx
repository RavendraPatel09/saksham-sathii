          ...
          <div className="grid md:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="flex items-start gap-3 p-3 bg-muted/30 rounded-lg">
                <input type="checkbox" className="mt-1 w-4 h-4 rounded border-gray-300 dark:border-white/20 dark:bg-[#0F1726] text-primary focus:ring-primary" defaultChecked={i < 3} />
