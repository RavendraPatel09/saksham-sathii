    ...
    <div className="container mx-auto px-4 py-8 space-y-12 max-w-7xl">
      <motion.div initial="hidden" animate="visible" variants={containerVariants} className="space-y-12">
        ...
        <motion.section variants={itemVariants} className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-500/10 via-background to-purple-500/10 border p-8 md:p-12 shadow-sm">
          <div className="relative z-10 grid md:grid-cols-2 gap-8 items-center">
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="bg-white/60 dark:bg-[#0F1726]/80 backdrop-blur-md border-indigo-500/20 shadow-lg">
              ...
              <Card className="bg-white/60 dark:bg-[#0F1726]/80 backdrop-blur-md border-purple-500/20 shadow-lg">
                <CardContent className="p-6 flex flex-col justify-between h-full">
                  <div className="flex justify-between items-start mb-2">
                  ...
                  <div>
                    ...
                    <div className="text-xl font-bold mt-1 text-purple-600 dark:text-purple-400">Tomorrow, 10 AM</div>
        ...
        <motion.div variants={itemVariants} className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Button variant="outline" className="h-16 flex flex-col items-center justify-center gap-1 bg-white dark:bg-[#0F1726] border-border/50 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 hover:text-indigo-600 hover:border-indigo-200">
          ...
          <Button onClick={() => setShowAuditModal(true)} variant="outline" className="h-16 flex flex-col items-center justify-center gap-1 bg-white dark:bg-[#0F1726] border-border/50 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 hover:text-indigo-600 hover:border-indigo-200">
          ...
          <Card className="premium-card bg-gradient-to-r from-primary/5 via-transparent to-indigo-500/5">
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="p-4 border rounded-xl bg-white/50 dark:bg-[#0F1726]/80 border-border/50 dark:border-white/[0.08] hover:shadow-md transition-all cursor-pointer">
