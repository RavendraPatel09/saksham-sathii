...
export const BottomNav = ({ onOpenMore }: { onOpenMore?: () => void }) => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 z-40 w-full border-t border-border/50 dark:border-white/[0.08] bg-white/90 dark:bg-[#070B14]/90 backdrop-blur-xl md:hidden shadow-[0_-4px_20px_-1px_rgb(0,0,0,0.1)]">
