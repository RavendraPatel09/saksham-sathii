...
export const SpeechComposer = () => {
  ...
  return (
    <div className="bg-white dark:bg-[#0F1726] border border-border/50 dark:border-white/[0.08] rounded-xl shadow-lg flex flex-col h-full max-h-[600px] overflow-hidden">
